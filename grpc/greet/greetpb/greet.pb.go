...
const file_greetpb_greet_proto_rawDesc = "" +
	...
	"\x04text\x18\x03 \x01(\tR\x04text2<\n" +
	"\aGreeter\x121\n" +
	"\x05Greet\x12\x12.greeting.Greeting\x1a\x12.greeting.Greeting\"\x00B1Z/github.com/hwipl/snippets-go/grpc/greet/greetpbb\x06proto3"
...
var file_greetpb_greet_proto_depIdxs = []int32{
	0, // 0: greeting.Greeter.Greet:input_type -> greeting.Greeting
	0, // 1: greeting.Greeter.Greet:output_type -> greeting.Greeting
